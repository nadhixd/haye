...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5605603670").split())
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/Ur_Karma_Baby"
)  # Example:- https://t.me/TheTeamVivek
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/MEETUPZONE_CHATTING"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/nadhixd/haye")
